...
static double nmf_dry(gtime_t time, const double pos[], const double azel[])
{
    /* ref [5] table 3 */
    /* hydro-ave-a,b,c, hydro-amp-a,b,c, wet-a,b,c at latitude 15,30,45,60,75 */
    const double coef[][5]={
...
static double nmf_wet(gtime_t time, const double pos[], const double azel[])
{
    /* ref [5] table 3 */
    /* hydro-ave-a,b,c, hydro-amp-a,b,c, wet-a,b,c at latitude 15,30,45,60,75 */
    const double coef[][5]={
...
{
    return nmf_dry(time,pos,azel);
}
else if (opt == 2)
{
    return nmf_wet(time,pos,azel);
}
