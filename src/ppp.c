                  ...
                  double phw, double *meas, double *var)
{
    ...
    if (NFREQ >= 3 && (satsys(obs->sat, NULL) & (SYS_GAL | SYS_SBS)))
        j = 2;
...
/* Subroutine */ int vmf1_ht__(doublereal *ah, doublereal *aw, doublereal *dmjd, doublereal *dlat, doublereal *ht, doublereal *zd, doublereal *vmf1h, doublereal *vmf1w)
{
    /* Builtin functions */
