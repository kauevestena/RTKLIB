...
# TO MODIFY:
proc_scenario = "mod_vmf3_grads_no_deriv"
...
proc_sc_root = {
    ...
    "mod_vmf3_grads_lat_br": os.path.join(outputs_path, "mod_vmf3_grads_lat_br"),
    "mod_vmf3_grads_no_deriv": os.path.join(
        outputs_path, "mod_vmf3_grads_no_deriv"
    ),
...
proc_sc_execs = {
    ...
    "mod_vmf3_grads_lat_br": exec_paths["mod"],
    "mod_vmf3_grads_no_deriv": exec_paths["mod"],
